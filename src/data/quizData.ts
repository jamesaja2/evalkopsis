...
const captchaQuestions: QuizQuestion[] = [
  {
    ...
    type: 'text',
    answer: ['angel'],
    hint: 'Namanya sama dengan makhluk bersayap yang suci',
  },
  {
    id: 'q2',
    ...
    type: 'text',
    answer: ['eternity'],
    hint: 'Kata dalam bahasa Inggris yang berarti "selamanya"',
  },
  {
    id: 'q3',
    ...
    type: 'text',
    answer: ['mecas'],
    hint: 'Nama panggilan yang mirip dengan brand teknologi terkenal',
  },
  {
    id: 'q4',
    ...
    type: 'text',
    answer: ['bendahara'],
    hint: 'Orang yang mengurus keuangan organisasi',
  },
  {
    id: 'q5',
    ...
    hint: 'Angka yang simetris jika dibalik',
  },
  {
    id: 'q6',
    ...
    hint: 'Aktivitas bermain dengan papan dan kartu',
  },
  {
    id: 'q7',
    ...
    type: 'text',
    answer: ['marc'],
    hint: 'Nama yang dimulai dengan huruf "M" dan diakhiri "C"',
  },
];
